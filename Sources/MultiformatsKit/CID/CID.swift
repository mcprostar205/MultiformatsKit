...
///
///         // Decode the CID.
///         let decodedCID = try CID.decode(from: "bafybeiadp6jhqmgdkmf7tlyimehev3wog2ghn6n6ojdqtfzmja3a7ky6rm")
...
///
///         // Decode the CID.
///         let decodedCID = try CID.decode(from: "QmNaJkvSxpCskJLtDajChFFQGsNDu9HCNc6XeWxep5Nf7p")
